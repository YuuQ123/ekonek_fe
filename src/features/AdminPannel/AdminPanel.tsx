    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-500 via-purple-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="mb-8">
            <h1 className="text-5xl font-bold mb-4">eKonek</h1>
            <h2 className="text-3xl font-semibold mb-6">Hi Admin!</h2>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Log in
              </button>
            </form>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-xl">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm font-medium text-blue-800">Keamanan Tinggi</p>
                  <p className="text-xs text-blue-600 mt-1">
                    Panel admin dilindungi dengan enkripsi tingkat tinggi. 
          ...
          <div className="lg:hidden text-center mt-8">
            <h1 className="text-2xl font-bold text-gray-800">eKonek</h1>
